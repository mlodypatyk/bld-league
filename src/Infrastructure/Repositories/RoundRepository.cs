    ...
    ReadWriteRepositoryBase<Round>(context), IRoundRepository
{
    ...
    private static LiveRoundRowDto BuildFinishedRow(
        ...
        => new LiveRoundRowDto
        {
            ...
            Solve1 = solves.Count > 0 ? solves[0] : SolveResult.Dns(),
            Solve2 = solves.Count > 1 ? solves[1] : SolveResult.Dns(),
            Solve3 = solves.Count > 2 ? solves[2] : SolveResult.Dns(),
            Solve4 = solves.Count > 3 ? solves[3] : SolveResult.Dns(),
            Solve5 = solves.Count > 4 ? solves[4] : SolveResult.Dns(),
            Best = best,
            Average = average,
        };
